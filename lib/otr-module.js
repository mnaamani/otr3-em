 ...
 return (function(o){
    ...
    switch(o.EVENT){
        ...
        case "remote_disconnected":
            ...
            return;
        case "policy":                  
            if(!otrSession.parameters) return POLICY("DEFAULT");
        ...
        case "max_message_size":
            if(!otrSession.parameters) return 0; //default to no fragmentation if not specified
            return otrSession.parameters.MTU || 0; //default to no fragmentation
        case "inject_message":
        ...
        case "write_fingerprints":
            debug(o.EVENT);
            //otrSession.user.writeFingerprints();//app must decide weather to write fingerprints to file or not
            emit(o.EVENT);
            return;
        case "still_secure":
            debug(o.EVENT);
